# Generated by Django 3.0.5 on 2024-11-23 14:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(choices=[('Kenya', 'Kenya'), ('Uganda', 'Uganda'), ('Tanzania', 'Tanzania'), ('Ghana', 'Ghana'), ('Rwanda', 'Rwanda'), ('Congo Brazzaville', 'Congo Brazzaville'), ('South Africa', 'South Africa'), ('Nigeria', 'Nigeria'), ('Egypt', 'Egypt'), ('S. Sudan', 'S. Sudan'), ('Malawi', 'Malawi'), ('Senegal', 'Senegal'), ('Madagascar', 'Madagascar'), ('Mauritius', 'Mauritius')], default='Kenya', max_length=255, verbose_name='Country of Origin')),
                ('location', models.CharField(default='Nairobi', max_length=255, verbose_name='Location of the seller item')),
                ...
                ('seller', models.ForeignKey(default=None, max_length=255, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='who is selling the item')),
            ],
            options={
